package com.example.cores.alpha.jpa.config;
...
import com.example.cores.alpha.CoresAlphaPersistenceMarker;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackageClasses = CoresAlphaPersistenceMarker.class, entityManagerFactoryRef = "localContainerEntityManagerFactoryBean")
public class AlphaJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean(@Qualifier("dataSourceSample") DataSource dataSource) {
        ...
        entityManagerFactoryBean.setPackagesToScan(new String[] { "com.example.cores.alpha.jpa" });
