package com.example.cores.beta.jpa.config;
...
import com.example.cores.beta.CoresBetaPersistenceMarker;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackageClasses = CoresBetaPersistenceMarker.class, entityManagerFactoryRef = "localContainerEntityManagerFactoryBean")
public class BetaJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean(@Qualifier("dataSourceSample") DataSource dataSource) {
        ...
        entityManagerFactoryBean.setPackagesToScan(new String[] { "com.example.cores.beta.jpa" });
