package com.example.cores.gamma.jpa.config;
...
import com.example.cores.gamma.CoresGammaPersistenceMarker;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackageClasses = CoresGammaPersistenceMarker.class, entityManagerFactoryRef = "localContainerEntityManagerFactoryBean")
public class GammaJpaConfig {
